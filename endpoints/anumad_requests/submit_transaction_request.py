...
async def submit_a_new_transaction(body: SubmitTransactionRequest):
    """
    Forwards the body directly to anumad with the command submitTransactionRequest
    """
    tx_resp = await anumad_client.request("submitTransactionRequest",
                                          params=body.dict())
