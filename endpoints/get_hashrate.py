...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Anuma network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Anuma network info"])
@sql_db_only
