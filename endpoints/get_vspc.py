...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Anuma network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this anumad's current virtual.
    """
    resp = await anumad_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
