...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_anumad_info, \
...
from endpoints.anumad_requests.submit_transaction_request import submit_a_new_transaction
from helper import get_anum_market_data
...
print(
    ...
    f"{get_anumad_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
...
async def startup():
    ...
    # get anumad
    await get_anum_market_data()

    # find anumad before staring webserver
